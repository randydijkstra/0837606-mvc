                ...
                @if (Auth::user()->profile)
                  <form action="/profile/edit" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="location" id="location" class="form-control" value="{{ Auth::user()->profile->location}}">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-2" >Homefield</label>
                      <div class="col-sm-10">
                          <input type="text" name="homefield" id="homefield" class="form-control" value="{{ Auth::user()->profile->home_field }}">
                      </div>
                    </div>
                    <div class="form-group">
